> Source: c64prg.txt Appendix G, "VIC Chip Register Map". From the Commodore 64 Programmer's Reference Guide. Lightly cleaned from the Project 64 etext (page-break tildes and running footers removed).
