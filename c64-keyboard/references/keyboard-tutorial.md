> Source: c64ug.txt Ch1.5 (Color Adjustment) and Ch2 (Getting Started — keyboard). Lightly cleaned from the Project 64 etext.

# Getting Started: The Keyboard (User's Guide)

## Using the CTRL key for colors and reverse (intro)
