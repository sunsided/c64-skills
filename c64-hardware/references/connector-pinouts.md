> Source: c64prg.txt Appendix I, "Pinouts for Input/Output Devices". Lightly cleaned from the Project 64 etext. For how to drive these ports from software see the c64-io / c64-game-ports / c64-disk / c64-tape skills; for the chip-side pinouts (CIA/SID/VIC/6510/PLA/DRAM) see `board-identification.md`.
