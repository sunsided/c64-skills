> Source: c64prg.txt §Appendix G "VIC Chip Register Map". Lightly cleaned from the Project 64 etext. Convenience copy; for the cycle-exact VIC-II reference see the c64-vic-ii skill.
